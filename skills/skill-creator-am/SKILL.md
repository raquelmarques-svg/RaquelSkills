...
licoes_aplicadas:
  - L1, L2, L3, L4, L5, L6, L7, L8, L9, L10, L11, LM1, LM2
regras_aplicaveis:
...
Se algum desses não existe, sinalizo e proponho criação no Sprint 0.
...
3.  Rodar 7 verificações pré-criação (bloqueantes)
...
Detalhe das 7 verificações em `references/01-verificacoes-pre-criacao.md`.
Detalhe das 12 auditorias em `references/02-auditorias-pos-criacao.md`.
...
Auditoria pontual de uma skill por demanda:
