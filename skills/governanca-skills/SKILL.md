...
3. **Modo** (`completo` = A1-A21 | `rápido` = apenas bloqueantes A1/A2/A11/A17/A19)
...
- Para cada skill: executar checklist A1-A21 e classificar VERDE/AMARELO/VERMELHO
...
SCRIPT AUXILIAR: `scripts/rodar_audit_r9.py` — executa A1-A21 via Python
